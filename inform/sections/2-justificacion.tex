...
\begin{itemize}
    ...
    \item \textbf{CI}: cuatro workflows de GitHub Actions validan lint, pruebas, auditoría de dependencias y el levantamiento completo con Docker Compose; \texttt{sdd-enforcer} exige artefactos SDD en PRs de ramas \texttt{feature/} que modifican \texttt{frontend/} o \texttt{backend/}.
